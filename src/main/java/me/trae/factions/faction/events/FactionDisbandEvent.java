...
public class FactionDisbandEvent extends FactionCancellableEvent implements IPlayerEvent {

    private final Player player;

    public FactionDisbandEvent(final Faction faction, final Player player) {
        super(faction);
